...
const dataURL =
  "https://project-1-api.herokuapp.com/comments?api_key=4008d7c8-7354-47b9-80c4-c2e5895e726f";
...
function likeComment(id, counterLike) {
  axios
    .put(
      `https://project-1-api.herokuapp.com/comments/${id}/like?api_key=4008d7c8-7354-47b9-80c4-c2e5895e726f`
    )
    .then((response) => {
...
function deleteComment(id) {
  swal({
    ...
    if (willDelete) {
      axios
        .delete(
          `https://project-1-api.herokuapp.com/comments/${id}?api_key=4008d7c8-7354-47b9-80c4-c2e5895e726f`
        )
        .then(() => {
          swal({
            title: "Done!",
